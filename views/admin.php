...
if (!empty($_GET['message'])) {
    echo '<p class="success-message">' . htmlspecialchars(trim($_GET['message'])) . '</p>';
}
...
<section class="main-container-admin">
    ...
    <div class="admin-buttons-header">
        ...
        <div class="admin-buttons-container">
            ...
            <button class="secondary-button" onclick="window.location.href='../public/index.php?page=rentals';">ZARZĄDZAJ
                REZERWACJAMI
            </button>
        </div>
